 ...
 *
 */
//转入gradle工程之后, 该类的实现方式将被Android-ViewPagerIndicator,
//https://github.com/JakeWharton/Android-ViewPagerIndicator 代替
        ...
        if (pager != null && pager.getAdapter() != null) {
            ...
            for (int i = 0; i < pager.getAdapter().getCount(); i++) {
                ...
                if (i == pager.getCurrentItem()) {
                    item.setImageResource(R.drawable.ic_pager_indicator_selected);
                } else {
                    item.setImageResource(R.drawable.ic_pager_indicator_normal);
                }
