...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation.setAnimationListener(mSplashAnimationListener);
        view.setAnimation(animation);
    }

    private AnimationListener mSplashAnimationListener = new AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            Animation translateAnimation = new TranslateAnimation(0, 0,
                    -400 * CommonUtils.getScreenDensity(SplashActivity.this), 0);
